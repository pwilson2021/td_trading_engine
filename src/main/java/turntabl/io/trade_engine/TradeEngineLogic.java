...
//
//    @Autowired
//    public TradeEngineLogic(int order_id) {
...
//        TradeEngineLogic tradeEngineLogic = new TradeEngineLogic(4);
//    }
//
//
...
//                TradeModel tradeModel = new TradeModel(order.getProduct().getTicker(), qtyToBuy, orderSet.get(i).getPrice(), order.getOrder_type());
//                tradeEngineRabbitMqSender.send(tradeModel);
//            } else {
